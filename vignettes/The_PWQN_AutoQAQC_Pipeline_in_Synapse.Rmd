...
Expected value ranges for each parameter by season and location, accounting for natural environmental variations. 

Each sensor's seasonal thresholds were established via historical data analysis of previous years' sensor data. If data quantity or quality created an issue in creating these thresholds, they were established manually through expert knowledge of the system. As more data is verified and the quantity/quality issues continue to improve, those manually established thresholds will be updated with the thresholds established through the more rigorous historical data analysis of the data.
