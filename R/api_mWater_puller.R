...
#' @export
#'
#' @description A function that downloads and cleans field notes from mWater. This
#' function handles time zone conversion, standardizes text fields, and prepares
...
#' @seealso [api_mWater_grab_sensor_notes()]
#' @seealso [api_mWater_grab_malfunction_notes()]

api_mWater_puller <- function(creds = yaml::read_yaml("creds/mWaterCreds.yml"), summarize_interval = "15 minutes"){
