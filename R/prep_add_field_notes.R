...
#' site-parameter combination, typically an element generated by `prep_bind_datasets`.
#'
#' @param notes A dataframe containing processed field notes from mWater, typically
#' the output from `api_mWater_grab_sensor_notes()`. These notes include information
...
prep_add_field_notes <- function(df, notes) {
