...
#'
#' @param api_token OAuth client object obtained from api_HydroVu_auth() function, used
...
#' Usually generated by calling `api_HydroVu_locations_all()`.
#'
...
api_HydroVu_puller <- function(site,
